...
2. Enable the "Allow External Interaction" option in "Settings".  
![alt text](images/image.png)  

3. Open a schematic or PCB view, then click "Advanced" > "Document Generator" in the top navigation bar and select the desired function.  
